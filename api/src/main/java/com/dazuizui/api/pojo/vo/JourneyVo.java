package com.dazuizui.api.pojo.vo;
...
public class JourneyVo implements Serializable {
    ...
    public JourneyVo(int id, String title, String content, Date createTime, Date updateTime, String updateBy, String createBy, int delFlag, int status, String journeyType, Integer journeyorder, String replenish, String icon) {
        this.id = id;
        this.title = title;
        this.content = content;
        this.createTime = createTime;
